        ...
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="https://www.threads.com/@alphonseamoule?xmt=AQG0D04L2b6SljvJw_sJ67lRuipQlsCez1t5W17gIpv9MA4" target="_blank" rel="noopener noreferrer" aria-label="Threads" className="w-10 h-10 inline-flex items-center justify-center rounded-full border border-border hover:border-primary hover:text-primary transition-colors"><Instagram className="w-4 h-4" /></a>
