      ...
      <div className="container py-16">
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-5 space-y-4">
            <a href="#home" className="inline-flex items-center gap-2 font-display font-bold text-2xl">
              <span className="tracking-[0.25em]">PORTFOLIO</span>
            </a>
            <p className="text-muted-foreground max-w-md leading-relaxed">
              Alphonse Yawo AMOULE — Marketing digital, création de contenu et stratégie de communication. Transformons vos idées en résultats.
            </p>
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="w-10 h-10 inline-flex items-center justify-center rounded-full border border-border hover:border-primary hover:text-primary transition-colors"
              >
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:amoulealphonse38@gmail.com" className="hover:text-primary transition-colors break-all">
                  amoulealphonse38@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-3">
