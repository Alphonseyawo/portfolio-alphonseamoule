        ...
        >
          <div className="max-w-2xl">
            ...
            <h2 className="font-display text-4xl lg:text-6xl font-bold leading-tight">
              Quelques réalisations <span className="text-gradient italic">récentes</span>.
            </h2>
          </div>
          <p className="text-muted-foreground max-w-sm">
            Une sélection de missions menées pendant mon stage et mes projets personnels — du contenu éditorial au design social.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="relative grid lg:grid-cols-12 gap-8 items-start">
                <div className="lg:col-span-1">
                  <div className="font-display text-5xl font-bold text-muted-foreground/40 group-hover:text-primary transition-colors">
                    {project.n}
                  </div>
                </div>
                ...
                <div className="lg:col-span-7">
                  ...
                  <h3 className="font-display text-2xl lg:text-4xl font-semibold mb-4 group-hover:text-primary transition-colors">
                    {project.title}
                  </h3>
                ...
                <div className="lg:col-span-1 flex lg:justify-end">
                  <div className="w-14 h-14 rounded-full border border-border flex items-center justify-center group-hover:bg-primary group-hover:border-primary group-hover:text-primary-foreground transition-all duration-500">
