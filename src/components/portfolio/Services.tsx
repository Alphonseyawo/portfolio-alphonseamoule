...
const services = [
  ...
  { icon: Megaphone, title: "Publicité digitale", desc: "Conception et gestion de campagnes publicitaires ciblées sur Meta, Google pour maximiser la visibilité et les conversions.", tags: ["Meta Ads", "Google Ads"] },
