...
const services = [
  ...
  { icon: Megaphone, title: "Publicité digitale", desc: "Conception et gestion de campagnes publicitaires ciblées sur Meta, Google et pour maximiser la visibilité et les conversions.", tags: ["Meta Ads", "Google Ads", "TikTok Ads"] },
